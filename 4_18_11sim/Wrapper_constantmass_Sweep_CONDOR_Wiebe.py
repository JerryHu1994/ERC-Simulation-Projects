...
# hardcode inputs for each run
ivc_range_arr = np.array([370, 375, 380, 385, 390, 395, 400, 405, 410, 415, 420])
Wiebe_theta_0_arr = np.array([-1, 2, 6, 8, 3, 8, 8.5, 8.5, 8.5, 8.5, 8,5])
Wiebe_delta_theta_arr = np.array([40, 40, 44, 47, 52, 46, 47, 47, 47, 47, 47]) 
BFlag_arr = np.array([0.95, 0.96, 0.95, 0.96, 0.96, 0.96, 0.96, 0.94, 0.94, 0.96, 0.95])
...
name=datetime.datetime.now().strftime("20%y%m%d_%H-%M.%S_Iso_2000rpm_Wiebe")
ws=wb.active
