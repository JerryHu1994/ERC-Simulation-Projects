...
ivc_range_arr = np.array([345,355,365,375])
Wiebe_theta_0_arr = np.array([2,4,6,15])
Wiebe_delta_theta_arr = np.array([39,40,40,39]) 
BFlag_arr = np.array([0.95, 0.95, 0.95, 0.95])
