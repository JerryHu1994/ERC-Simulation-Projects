...
ivc_range_arr = np.array([340, 350, 355, 360, 365, 370, 375])
Wiebe_theta_0_arr = np.array([5, 9, 13, 16, 18, 18, 18])
Wiebe_delta_theta_arr = np.array([37, 38, 40, 45, 41, 41, 41]) 
BFlag_arr = np.array([0.96, 0.96, 0.95, 0.95, 0.95, 0.95, 0.95])
...
tic=time.time()
fname='Iso_1000rpm_CONDOR_Step4.xlsx'

wb=load_workbook(fname)
name=datetime.datetime.now().strftime("20%y%m%d_%H-%M.%S_Iso_1000rpm_Wiebe")
ws=wb.active
